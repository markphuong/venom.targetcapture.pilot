...
def align(element):
	...
	commands = """
	python guess_regions.py {ID}_best_venom_hits.fasta mynewreference.fa venom_proteins_guess.fa {ID}.venom_exon.filtered.blastoutput {ID}_define_exon.blastoutputs {ID}_definedseqs.fa
	""".format(**variables)
