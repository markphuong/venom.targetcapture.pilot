...
def align(element):
	...
	commands = """
	makeblastdb -dbtype nucl -in {ID}_venom_contigs_reassembled.fa.NI.subset
	python add_column_to_bed.py {species}_venombed {species}_venombed_annotated
	python add_column_to_bed_utr.py {species}_venombed_utr {species}_venombed_utr_annotated
	python slice_proteins.py {ID} {species}
