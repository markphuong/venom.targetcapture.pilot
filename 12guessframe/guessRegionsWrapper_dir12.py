...
def align(element):
	...
	commands = """
	python guess_regions_dir12.py {ID}_need_to_guessagain.fa mynewreference.fa all_cut_and_translated.fa {ID}.venom_exon.filtered.blastoutput {ID}_define_exon_v5.5addon.blastoutputs {ID}_definedseqs_v5.5_addon.fa
	""".format(**variables)
