...
myalternatives = open(sys.argv[1] + '_alternative_alleles_dir10', 'r')
...
myfasta = open(sys.argv[1] + '_definedseqs_v4.fa', 'r')
...
out = open(ID + '_definedseqs_v5.fa', 'w')
failed = open(ID  + '_failed_cov_dir10.fa', 'w')
